...
#Comparing other columns with QQ plot
qqplot(EPI,ENVHEALTH)

qqplot(EPI,PopulationDensity07)

#More visualization exercises

#Boxplots
boxplot(EPI,ENVHEALTH,names = c('EPI','ENVHEALTH'))
title(main='Boxplot')

#GG Plot

ggplot(EPI,aes(x=EPI)) + geomboxplot() #NEED CLARIFICATION
