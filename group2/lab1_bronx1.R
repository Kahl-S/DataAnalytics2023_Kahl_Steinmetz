...
#alternate
setwd("C:/Users/kahls/Desktop/group2")
library(xlsx)
bronx1<-read.xlsx("NYhousing/rollingsales_bronx.xls",pattern="BOROUGH",stringsAsFactors=FALSE,sheetIndex=1,startRow=5,header=TRUE)
bronx1<-bronx1[!(bronx1$SALE.PRICE == 0|bronx1$GROSS.SQUARE.FEET == 0|bronx1$LAND.SQUARE.FEET==0),]
View(bronx1)
#
